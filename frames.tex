...
\[
	A \left| \left| w_A \right| \right|^2 = \sum_{h=1}^m \left| \left< w_A, f_h\right> \right|^2,
\]
\[
	\sum_{h=1}^m \left| \left< w_B, f_h\right> \right|^2 = B \left| \left| w_B\right| \right|^2
\]. Тогда для них также будет выполняться
\[
	\begin{aligned}
	A \left| \left| w_A \right| \right|^2 = \sum_{h=1}^m \left| \left< w_A, Pf_h\right> \right|^2 \\
	\sum_{h=1}^m \left| \left< w_B, Pf_h\right> \right|^2 = B \left| \left| w_B\right| \right|^2
\end{aligned},
\]
