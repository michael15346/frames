...
Отсюда
\[
	\lambda_{\min} \left| \left| f \right| \right|^2 = \lambda_{\min} \sum_{k=1}^m \left| \left< f, e_k \right> \right|^2 \le \sum_{k=1}^m \lambda_k \left| \left< f, e_k \right> \right|^2 \le \lambda_{\max} \sum_{k=1}^m \left| \left< f, e_k \right> \right|^2 = \lambda_{\max} \left| \left| f \right| \right|^2,
\]
и
\[
